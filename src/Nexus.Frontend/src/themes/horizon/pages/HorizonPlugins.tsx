...
export function HorizonPlugins() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8 font-sans">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4"><div><h2 className="text-3xl font-extrabold text-[var(--text)]">Plugin Manager</h2><p className="text-sm text-[var(--text-sub)] mt-1">Manage built-in and custom extensions.</p></div></div>
