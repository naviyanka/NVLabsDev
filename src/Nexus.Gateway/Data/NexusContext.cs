...
public class NexusContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PluginEntity>().HasData(
            ...
            new PluginEntity { Id = "builtin-sharepoint", Name = "SharePoint Setup", Description = "Automate SharePoint deployments", Icon = "server", Category = "Management", IsBuiltIn = true, IsActive = true, TargetRoute = "/sharepoint-setup" },
            ...
            new PluginEntity { Id = "builtin-defender", Name = "Windows Defender", Description = "Antivirus Management", Icon = "shield", Category = "Security", IsBuiltIn = true, IsActive = true, TargetRoute = "/defender" },
